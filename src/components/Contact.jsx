    ...
    <footer id="contact" className="relative z-10 pt-20 pb-10 bg-dark-bg/50 border-t border-magenta-900/30 mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="pt-8 border-t border-dark-border flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-4">
            <a href="#" className="w-10 h-10 rounded-full bg-dark-card border border-dark-border flex items-center justify-center text-gray-400 hover:text-magenta-400 hover:border-magenta-500/50 transition-all">
              <FaGithub size={18} />
            </a>
            <a href="#" className="w-10 h-10 rounded-full bg-dark-card border border-dark-border flex items-center justify-center text-gray-400 hover:text-magenta-400 hover:border-magenta-500/50 transition-all">
              <FaLinkedin size={18} />
            </a>
            <a href="#" className="w-10 h-10 rounded-full bg-dark-card border border-dark-border flex items-center justify-center text-gray-400 hover:text-magenta-400 hover:border-magenta-500/50 transition-all font-bold text-xs">
              LC
            </a>
          </div>
        </div>
